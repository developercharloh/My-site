    ...
    source: {
        ...
        define: {
            'process.env': {
                ...
                // Pre-configured token for new Deriv accounts — set as a Replit secret.
                // When set, new-gate users are logged in silently without any wizard.
                DERIV_NEW_TOKEN: JSON.stringify(process.env.DERIV_NEW_TOKEN || ''),
            },
        },
    },
    resolve: {
