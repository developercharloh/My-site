"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["accumulators_reverse_dalembert-xml"],{"../../bot-web-ui/src/xml/accumulators_reverse_dalembert.xml"(a,e,n){n.r(e),n.d(e,{default:()=>l});const l=`<xml xmlns="https://developers.google.com/blockly/xml" is_dbot="true" collection="false">
  <variables>
    ...
    <variable id="0YJhdQq!Kwdb*xG1i1/{">isBought</variable>
    <variable id="0%!EpnJi{xaz5Lgs4e@l">Current Tick Value</variable>
    ...
    <variable id="uLtb(Q#]US~aG:@0t=de">Tick Count</variable>
          ...
          <block type="variables_set" id="3TlyeuH4#I\`36K:;)tho">
            ...
            <next>
              <block type="variables_set" id="{1+n32AGU]3\`2N+$@-D;">
                ...
                <next>
                  <block type="variables_set" id="jC$,!*X4+3_W-f1J%4QP">
                    <field name="VAR" id="uLtb(Q#]US~aG:@0t=de">Tick Count</field>
                    <value name="VALUE" strategy_value="tick_count">
                      <block type="math_number" id=":^Bi@ZDXFXxiLc-0!yj:">
                        <field name="NUM">5</field>
                      </block>
                    </value>
                    <next>
                      <block type="variables_set" id="l)DeyYOC[ivS0XC6BQy#">
                        <field name="VAR" id="0YJhdQq!Kwdb*xG1i1/{">isBought</field>
                        <value name="VALUE">
                          <block type="logic_boolean" id="XX!gi(9Om_sp7sC#h\`~\`">
  ...
  <block type="during_purchase" id="B4QJeQ67q*@XdH*O8w?." x="714" y="0">
    <statement name="DURING_PURCHASE_STACK">
      <block type="variables_set" id="o{W3wb)3l:)9!d1\`j2G-">
        <field name="VAR" id="0YJhdQq!Kwdb*xG1i1/{">isBought</field>
        <value name="VALUE">
          <block type="logic_boolean" id="j+2G7?K=BQGFw.J[;.b8">
            <field name="BOOL">TRUE</field>
          </block>
        </value>
        <next>
              ...
              <block type="controls_if" id="VoZV!|z\`hM0Ht:}kw_*p">
                <value name="IF0">
                  <block type="logic_compare" id="2rxD941).5_(8i|a-N:n">
                    ...
                    <value name="A">
                      <block type="variables_get" id="=zg,yPA/LiG)n-19q0uw">
                        <field name="VAR" id="0%!EpnJi{xaz5Lgs4e@l">Current Tick Value</field>
                      </block>
                    </value>
                    <value name="B">
                      <block type="variables_get" id="k0hdo/lFjyG9Ql@9X}E/">
                        <field name="VAR" id="uLtb(Q#]US~aG:@0t=de">Tick Count</field>
                      </block>
                    </value>
                  </block>
  ...
  <block type="before_purchase" id="27txn/aPf2v^$qc((-t$" deletable="false" x="0" y="889">
    <statement name="BEFOREPURCHASE_STACK">
      <block type="variables_set" id=",2*[Ll,n0PDw^;d[U!y-">
        <field name="VAR" id="0%!EpnJi{xaz5Lgs4e@l">Current Tick Value</field>
        <value name="VALUE">
          <block type="math_number" id="Ue;gVzAH\${FuCWr.QLTg">
            <field name="NUM">0</field>
          </block>
        </value>
        <next>
          <block type="variables_set" id="lH?t8!~8rFJO./9l1LhW">
            <field name="VAR" id="0YJhdQq!Kwdb*xG1i1/{">isBought</field>
            <value name="VALUE">
              <block type="logic_boolean" id="=l($h}*3c@ir(kM~{vh+">
                <field name="BOOL">FALSE</field>
              </block>
            </value>
            <next>
  ...
  <block type="tick_analysis" id="XoP]D\`-o~eVN)K!LFn~C" x="0" y="1211">
    <statement name="TICKANALYSIS_STACK">
      <block type="controls_if" id="?6:q,mBSuX\`R_hAHN#ND">
        <value name="IF0">
          <block type="variables_get" id=")CDZcHR5M5=lmXYF!SqC">
            <field name="VAR" id="0YJhdQq!Kwdb*xG1i1/{">isBought</field>
          </block>
        </value>
        <statement name="DO0">
          <block type="variables_set" id="tf\`!?U^3_6(VPP8:0BX{">
            <field name="VAR" id="0%!EpnJi{xaz5Lgs4e@l">Current Tick Value</field>
            <value name="VALUE">
              <block type="math_arithmetic" id="r;Yi5QTHwKDEIXmhZ(N|">
                <field name="OP">ADD</field>
                <value name="A">
                  <shadow type="math_number" id="2vrm~hB.WX+HP^Lr~+-i">
                    <field name="NUM">1</field>
                  </shadow>
                  <block type="variables_get" id="YBb2z$Rv=$##;,_Ksr-:">
                    <field name="VAR" id="0%!EpnJi{xaz5Lgs4e@l">Current Tick Value</field>
                  </block>
                </value>
                <value name="B">
                  <shadow type="math_number" id="d%%1jT5pOe;/GXKC*AVK">
                    <field name="NUM">1</field>
                  </shadow>
                </value>
              </block>
  ...
  <block type="procedures_defnoreturn" id="y?vDuuwfiR,*DqC],*C:" collapsed="true" x="0" y="1475">
  ...
  <block type="procedures_defreturn" id="CI@IiTlr,.O=:m#QLq\`M" collapsed="true" x="0" y="1571">
  ...
  <block type="procedures_defreturn" id="-9(QN\`Sc2$IvQPr6M9QP" collapsed="true" x="0" y="1667">
    <mutation xmlns="http://www.w3.org/1999/xhtml">
