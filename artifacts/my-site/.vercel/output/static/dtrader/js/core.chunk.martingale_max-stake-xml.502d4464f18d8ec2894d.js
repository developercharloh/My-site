"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["martingale_max-stake-xml"],{"../../bot-web-ui/src/xml/martingale_max-stake.xml"(l,e,n){n.r(e),n.d(e,{default:()=>a});const a=`<xml xmlns="http://www.w3.org/1999/xhtml" is_dbot="true" collection="false">
  <variables>
    ...
    <variable type="" id="4vh+dtelQS#?}@cNPcN!" islocal="false" iscloud="false">maxStake</variable>
    <variable type="" id="3^~61:59m?#VJ(:SG^^[" islocal="false" iscloud="false">setMaxStake?</variable>
    <variable type="" id="]6T=O624:eVRioXro1kh" islocal="false" iscloud="false">Notification:currentStake</variable>
    <variable type="" id="lES4b_A$jwUMq,9_z2,I" islocal="false" iscloud="false">Notification:maxStakeExceeds</variable>
  </variables>
  <block type="trade_definition" id="i]\`fLRZ]?mshi{9kS+fg" deletable="false" x="0" y="0">
    ...
    <statement name="INITIALIZATION">
      <block type="variables_set" id="qKO~.\`hPZgl;YZp+5Gov">
        <field name="VAR" id="3^~61:59m?#VJ(:SG^^[" variabletype="">setMaxStake?</field>
        ...
        <next>
          <block type="variables_set" id="-jDR^266z(Nid-G$WXhp">
            <field name="VAR" id="4vh+dtelQS#?}@cNPcN!" variabletype="">maxStake</field>
  ...
  <block type="after_purchase" id="cb%w4#L|)A]1F1+)uk_u" x="803" y="0">
  ...
  <block type="procedures_defnoreturn" id="s\`u(+vlS44fI;pul:nfW" collapsed="true" x="0" y="832">
    ...
    <statement name="STACK">
      <block type="text_join" id="%BiEW1gsT2[%D%90GC3P">
        <field name="VARIABLE" id="]6T=O624:eVRioXro1kh" variabletype="">Notification:currentStake</field>
        <statement name="STACK">
          ...
          <block type="notify" id="X?l1])Y7!^m1aVJ$qnjS">
            ...
            <value name="MESSAGE">
              ...
              <block type="variables_get" id="(kmzO*5N^X\`^3uvRT9}+">
                <field name="VAR" id="]6T=O624:eVRioXro1kh" variabletype="">Notification:currentStake</field>
              </block>
            </value>
            <next>
                ...
                <statement name="DO0">
                  <block type="variables_set" id="BEp45H17VcN)bNjaC13X">
                    ...
                    <value name="VALUE" strategy_value="stake">
                      <shadow type="math_number" id="b2_/oC+c;}aB5SRVLOOf">
