"use strict";(self.webpackChunk=self.webpackChunk||[]).push([["accumulators_martingale_on_stat_reset-xml"],{"../../bot-web-ui/src/xml/accumulators_martingale_on_stat_reset.xml"(a,e,n){n.r(e),n.d(e,{default:()=>l});const l=`<xml xmlns="https://developers.google.com/blockly/xml" is_dbot="true" collection="false">
  <variables>
    ...
    <variable id="nWun2[d\`K?tRXQ;D(wO-">Sell by 'Count Down'? If false, sell by 'Take Profit'</variable>
    <variable id="R=dR,YjI96gAUHAbH=TS">isBought</variable>
    <variable id="ur6CjJkKe7n3PAv2Obz_">Current Tick Value</variable>
    ...
    <variable id="KcY7vz):rP2+yJ$(A(?0">Tick Count</variable>
  ...
  <block type="trade_definition" id="i]\`fLRZ]?mshi{9kS+fg" deletable="false" x="0" y="0">
    ...
    <statement name="INITIALIZATION">
      <block type="variables_set" id="Dngja$}#ANdsiIrL^q?x">
        <field name="VAR" id="nWun2[d\`K?tRXQ;D(wO-">Sell by 'Count Down'? If false, sell by 'Take Profit'</field>
        <value name="VALUE" strategy_value="boolean_tick_count">
          <block type="logic_boolean" id="X(CI)k$=V6v-R#ms}wBv">
        ...
        <next>
          <block type="variables_set" id="qKO~.\`hPZgl;YZp+5Gov">
            ...
            <value name="VALUE" strategy_value="boolean_max_stake">
              <block type="logic_boolean" id="%@4HYVeOB$jA\`7.ljdbf">
                <field name="BOOL">TRUE</field>
              </block>
            </value>
            <next>
              <block type="variables_set" id="-jDR^266z(Nid-G$WXhp">
                ...
                <value name="VALUE" strategy_value="max_stake">
                  <shadow type="math_number" id="FF1sPs*ENIx4n#SmKe|9">
                    <field name="NUM">1000</field>
                  </shadow>
                </value>
                <next>
                  <block type="variables_set" id="X3eDN\`E^h7-Frkuq:2xS">
                    <field name="VAR" id="KcY7vz):rP2+yJ$(A(?0">Tick Count</field>
                    <value name="VALUE" strategy_value="tick_count">
                      <block type="math_number" id="e_.?W6GD{Qx!Jf]VLu(a">
                        <field name="NUM">5</field>
                      </block>
                    </value>
                    <next>
                      <block type="variables_set" id="ZMpBA;%3ZZwIDGb[3U0F">
                        <field name="VAR" id="R=dR,YjI96gAUHAbH=TS">isBought</field>
                        <value name="VALUE">
                          <block type="logic_boolean" id="Umx1LM_5,^%[r:\`#[(iP">
    ...
    <statement name="SUBMARKET">
      <block type="trade_definition_accumulator" id="@HK1o6G!FQFODS;~q]5_">
        <field name="GROWTHRATE_LIST" strategy_value="growth_rate">0.01</field>
        <value name="AMOUNT">
          <shadow type="math_number_positive" id=".GMq]9MaqayjZ*#Y%cK_">
            <field name="NUM">1</field>
          </shadow>
          <block type="procedures_callreturn" id="Xuo*Yy7To9|}zL}F,np]">
        ...
        <statement name="ACCUMULATOR_PARAMS">
          <block type="accumulator_take_profit" id=":R|({jUQ%[USRr;PK_u0" disabled="true">
            <value name="AMOUNT" strategy_value="take_profit">
              <shadow type="math_number_positive" id="JQJxQxl0s4Fm%[LXGATK">
  ...
  <block type="during_purchase" id="gY/vf:wi;/$rB6W]Qz2@" x="714" y="0">
    <statement name="DURING_PURCHASE_STACK">
      <block type="variables_set" id="Wa_F0~eVe16o1d.9pddK">
        <field name="VAR" id="R=dR,YjI96gAUHAbH=TS">isBought</field>
        <value name="VALUE">
          <block type="logic_boolean" id="J_@oF(x0e7@(?9yUf#Wg">
            <field name="BOOL">TRUE</field>
          </block>
        </value>
        <next>
          <block type="controls_if" id="p.|74#@*nlVP@-ufk0-a">
            <value name="IF0">
              <block type="logic_operation" id="gebFc^+t7#z=u{3e@oe*">
                <field name="OP">AND</field>
                <value name="A">
                  <block type="check_sell" id=";5@)(zBZW7Z/z+E\`hfSP"></block>
                </value>
                <value name="B">
                  <block type="logic_compare" id="[qkuIVstpHuid-=^]RF5">
                    <field name="OP">EQ</field>
                    <value name="A">
                      <block type="variables_get" id="_?5JeKIh]1X@A\`?aeo{y">
                        <field name="VAR" id="nWun2[d\`K?tRXQ;D(wO-">Sell by 'Count Down'? If false, sell by 'Take Profit'</field>
                      </block>
                    </value>
                    <value name="B">
                      <block type="logic_boolean" id="[MBC*0#Z7eRa:oRsMzTf">
                        <field name="BOOL">TRUE</field>
                      </block>
                    </value>
                  </block>
            ...
            <statement name="DO0">
              <block type="controls_if" id="{a_-OL.b217_m9ebfk3S">
                <value name="IF0">
                  <block type="logic_compare" id="-0tkex*@u7O_}Vs@ctE1">
                    <field name="OP">GT</field>
                    <value name="A">
                      <block type="variables_get" id="ORRa.QKbHN.T575l7Y,]">
                        <field name="VAR" id="ur6CjJkKe7n3PAv2Obz_">Current Tick Value</field>
                      </block>
                    </value>
                    <value name="B">
                      <block type="variables_get" id="JpGdb3!GVXz_.l$#72zZ">
                        <field name="VAR" id="KcY7vz):rP2+yJ$(A(?0">Tick Count</field>
                      </block>
                    </value>
                  </block>
                ...
                <statement name="DO0">
                  <block type="sell_at_market" id="_E*C/miH4O!|,rzUL$\`]"></block>
                </statement>
              </block>
            </statement>
          </block>
  ...
  <block type="before_purchase" id="Z])37\`R^9KsrX4I7bAqP" deletable="false" x="0" y="890">
    <statement name="BEFOREPURCHASE_STACK">
      <block type="variables_set" id="_FXo4PFNdwb%D}31V40h">
        <field name="VAR" id="ur6CjJkKe7n3PAv2Obz_">Current Tick Value</field>
        <value name="VALUE">
          <block type="math_number" id="SNPOK25+(c!2^K,36qw4">
            <field name="NUM">0</field>
          </block>
        </value>
        <next>
          <block type="variables_set" id="{WUvd$@;4D4qZx(Hc2{d">
            <field name="VAR" id="R=dR,YjI96gAUHAbH=TS">isBought</field>
            <value name="VALUE">
              <block type="logic_boolean" id="yJv+lO-l@!~lMPL4qetP">
                <field name="BOOL">FALSE</field>
              </block>
            </value>
            <next>
              <block type="notify" id="YBm3.OP{L7y^WWz%GM#R">
                <field name="NOTIFICATION_TYPE">success</field>
                <field name="NOTIFICATION_SOUND">silent</field>
                <value name="MESSAGE">
                  <shadow type="text" id=".%V@!T-TyZB$$Noqg?+Y">
                    <field name="TEXT">abc</field>
                  </shadow>
                  <block type="stat" id="4PYa1n#5F{kHPi79prjk"></block>
                </value>
                <next>
                  <block type="controls_if" id="|qOsA7Ou~{+8#nB4v~?;">
                    <value name="IF0">
                      <block type="logic_compare" id="[*F7QfI,zqJmfw)18)%=">
                        <field name="OP">LTE</field>
                        <value name="A">
                          <block type="stat" id="CF4c}+_h-,TL@]r}:UZ0"></block>
                        </value>
                        <value name="B">
                          <block type="math_number" id="5=XoSJ2K;D\`R%.SDGpio">
                            <field name="NUM">5</field>
                          </block>
                        </value>
                      </block>
  ...
  <block type="tick_analysis" id="Cs6uvV=U=HpH=5KnO@*R" x="0" y="1300">
    <statement name="TICKANALYSIS_STACK">
      <block type="controls_if" id="Fex0[K|@~)Fc3A61w?fS">
        <value name="IF0">
          <block type="variables_get" id="LUT4RatjmH0oY5w=vaOB">
            <field name="VAR" id="R=dR,YjI96gAUHAbH=TS">isBought</field>
          </block>
        </value>
        <statement name="DO0">
          <block type="variables_set" id="S3g!=+UZA)]?rsz?E1Ce">
            <field name="VAR" id="ur6CjJkKe7n3PAv2Obz_">Current Tick Value</field>
            <value name="VALUE">
              <block type="math_arithmetic" id="q*j/u!)M_p;HLm_K|,6D">
                <field name="OP">ADD</field>
                <value name="A">
                  <shadow type="math_number" id="^ZnYn*/87A[%,;k9#h[E">
                    <field name="NUM">1</field>
                  </shadow>
                  <block type="variables_get" id="L4n;k_D\`lW:!WMqL*TDs">
                    <field name="VAR" id="ur6CjJkKe7n3PAv2Obz_">Current Tick Value</field>
                  </block>
                </value>
                <value name="B">
                  <shadow type="math_number" id="zzPtKljvt/DUI|+FwS%a">
                    <field name="NUM">1</field>
                  </shadow>
                </value>
              </block>
                  ...
                  <block type="variables_set" id="DA78AxndLk]Q@dIBt7O|">
                    ...
                    <value name="VALUE">
                      <block type="math_arithmetic" id="YzC3]lEc(!m8!NK/T/^0">
                        ...
                        <value name="A">
                          <shadow type="math_number" id="JiIb?jU|cTS9ID2=ymTt">
                            <field name="NUM">1</field>
                          </shadow>
  ...
  <block type="procedures_defreturn" id="x3TA)\`V~gtD7?rqNj[.9" collapsed="true" x="0" y="1660">
        ...
        <statement name="DO0">
          <block type="variables_set" id="{}-XA:3=]2W.Aq|zIiP(">
            ...
            <value name="VALUE"  strategy_value="profit">
              <block type="math_number" id="oey_#oK,W{kwyW]bH$Q0">
            ...
            <statement name="DO0">
              <block type="variables_set" id=":OS%IuonU;AkRO!H-SEF">
                ...
                <value name="VALUE" strategy_value="loss">
                  <block type="math_number" id="UdK4EIuuo|^~SBqy^_UN">
                ...
                <statement name="DO0">
                  <block type="variables_set" id="BEp45H17VcN)bNjaC13X">
                    ...
                    <value name="VALUE" strategy_value="stake">
                      <block type="math_number" id="b2_/oC+c;}aB5SRVLOOf">
                    ...
                    <statement name="DO0">
                      <block type="variables_set" id="-93lGY=!6I#8sh)~z\`3Z">
                        ...
                        <value name="VALUE" strategy_value="size">
                          <shadow type="math_number" id="V_wKk,@wB*OF9ev0RrZx">
    ...
    <value name="RETURN">
      <block type="math_arithmetic" id="MR,#W3HBlh/CZGh.TF:m">
        <field name="OP">MULTIPLY</field>
        <value name="A">
          <shadow type="math_number" id="*t[=VPB(NmY-cMX3:dO6">
            <field name="NUM">1</field>
          </shadow>
        ...
        <value name="B">
          <shadow type="math_number" id="?Lzpx;31!du)hkyJAyMv">
            <field name="NUM">1</field>
          </shadow>
  ...
  <block type="procedures_defreturn" id="N,_%hZ47\`]!eOyc7%u8]" collapsed="true" x="0" y="1756">
    ...
    <statement name="STACK">
      <block type="math_change" id="G)p)~Q+g*Hsak%Mg_PMd">
        <field name="VAR" id="Kb@{Vb{+5IqV=d~y*dcr">martingale:totalProfit</field>
        <value name="DELTA">
          <shadow type="math_number" id="g(TXU:-(3KX\`l~~2T=Zz">
            <field name="NUM">1</field>
          </shadow>
          ...
          <block type="variables_set" id="p?gdu**|cGlmOTw^G_D@">
            ...
            <value name="VALUE">
              <block type="math_arithmetic" id="lSSFZC-1xm}v~a9_Xw3@">
                ...
                <value name="A">
                  <shadow type="math_number" id="{,]fMNQwUWq?GM9.gSpu">
                    <field name="NUM">1</field>
                  </shadow>
                  <block type="math_round" id="qe@\`Q7,j_0|sTdj\`,F|B">
                    <field name="OP">ROUND</field>
                    <value name="NUM">
                      <shadow type="math_number" id="zG#~LT/USR!L[Fi~yLQU">
                        <field name="NUM">3.1</field>
                      </shadow>
                      <block type="math_arithmetic" id="9b({-h28~_/qs:s!*WkN">
                        <field name="OP">MULTIPLY</field>
                        <value name="A">
                          <shadow type="math_number" id="@1]ophW@#G,^I+]#wn|r">
                            <field name="NUM">1</field>
                          </shadow>
                  ...
                  <block type="text_join" id="jW!]JTxnzDnsTxu^+gT!">
                      ...
                      <block type="text_statement" id="Y3$$Wh@Fr:}*_(hMrtvA">
                        ...
                        <next>
                          <block type="text_statement" id="[(J[NV?+P0O}]:cG4cP}">
                            <value name="TEXT">
                              <shadow type="text" id=",udb!g!eu/XBt=\`)qa[/">
                                <field name="TEXT"></field>
                              </shadow>
                    ...
                    <next>
                      <block type="notify" id="e$Pci.r)?[2i9=/L]hI{">
                        ...
                        <field name="NOTIFICATION_SOUND">silent</field>
                        <value name="MESSAGE">
                          <shadow type="text" id="Cj(oB[EUx#jL3kRuZo.L">
                            <field name="TEXT">abc</field>
                          </shadow>
                                      ...
                                      <block type="logic_compare" id="%XaSru*P96b@:s~*f6/b">
                                        ...
                                        <value name="B">
                                          <block type="math_single" id="K9$ftop.bUpkoibNkVQL">
                                            ...
                                            <value name="NUM">
                                              <shadow type="math_number" id="=t1}v/jixBBllQX5A0{A">
                                          ...
                                          <block type="text_statement" id="db1K?]^sdr=ocll68sJz">
                                            ...
                                            <next>
                                              <block type="text_statement" id="Wf^WII2\`tL|r}@bNbN[o">
                                                <value name="TEXT">
                                                  <shadow type="text" id="j%jGgg;Ac1{HOB;x-5F+">
                                                    <field name="TEXT"></field>
                                                  </shadow>
                                                  <block type="math_single" id="\`6,2Jm!UJarPK~GWrlBz">
                                                    <field name="OP">NEG</field>
                                                    <value name="NUM">
                                                      <shadow type="math_number" id="V[O%X9!LWUSKl5c.t9Oj">
                                                        <field name="NUM">9</field>
                                                      </shadow>
                                          ...
                                          <block type="notify" id="m]|Q26uexXeXd2K]pmwI">
                                            ...
                                            <next>
                                              <block type="text_print" id="7Hu/[~lR.t.}-Yj{1)Uz">
                                                <value name="TEXT">
                                                  <shadow type="text" id="Yk+JpyV~\`(fXzSy+[+s{">
                                                    <field name="TEXT">abc</field>
                                                  </shadow>
                                      ...
                                      <block type="text_statement" id="*d%K,c1?SW4n,rFX.*li">
                                        ...
                                        <next>
                                          <block type="text_statement" id="-:.y|:f5RYmLM+7|FWbi">
                                            <value name="TEXT">
                                              <shadow type="text" id="tH=b=/fMw|l*+n5Vx9l=">
                                                <field name="TEXT"></field>
                                              </shadow>
                                      ...
                                      <block type="notify" id="^j7RbTu|i5~9Q?vzbn)f">
                                        ...
                                        <next>
                                          <block type="text_print" id="(3se7\`318IM+E4L\`y]h*">
                                            <value name="TEXT">
                                              <shadow type="text" id="$xDC_(0mm4nUfRZ-{Ag\`">
                                                <field name="TEXT">abc</field>
                                              </shadow>
