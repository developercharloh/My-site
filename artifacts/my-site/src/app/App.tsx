...
// Suspense wrapper that renders nothing while waiting, so the inline
// HTML shell defined in index.html remains visible until the real
// Layout chunk has loaded and mounted.
