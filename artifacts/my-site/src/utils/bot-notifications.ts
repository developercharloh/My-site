import { TNotificationMessage } from '@/types/stores.types';
...
export const switch_account_notification = () => ({
    ...
    message: localize(
        'Our system will finish any Mr CharlohFX trades that are running, and Mr CharlohFX will not place any new trades.'
    ),
    type: 'warning',
    is_persistent: true,
});
