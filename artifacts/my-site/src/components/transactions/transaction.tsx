...
export const VirtualTransaction = ({ data }: { data: TVirtualTransaction }) => (
    <div data-testid='dt_virtual_transaction_item' className='transactions__item-wrapper transactions__item-wrapper--virtual'>
        <div className='transactions__item'>
            <div className='transactions__cell transactions__trade-type'>
                <div className='transactions__loader-container'>
                    <TradeTypeIcon type={data.contract_type} size='sm' />
                </div>
                <div className='transactions__loader-container'>
                    <span className='transactions__virtual-label'>Virtual Hook</span>
                </div>
            </div>
            ...
            <div className='transactions__cell transactions__stake'>
                <span className='transactions__virtual-label'>—</span>
            </div>
            <div className='transactions__cell transactions__profit'>
                <span
                    className={classNames('transactions__virtual-result', {
                        'transactions__profit--win': data.is_won,
                        'transactions__profit--loss': !data.is_won,
                    })}
                >
                    {data.is_won ? localize('virtual won') : localize('virtual lost')}
                </span>
            </div>
        </div>
    </div>
