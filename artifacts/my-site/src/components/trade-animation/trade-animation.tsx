        ...
        <div className={classNames('animation__wrapper', className)}>
            {should_show_tooltip ? (
                ...
                <Button
                    is_disabled={
                        is_stop_button_visible
                            // Stop button must always be clickable as an
                            // emergency abort. The original code disabled it
                            // during PURCHASE_SENT (stage 3), which left the
                            // user stranded whenever a proposal/buy call
                            // stalled (slow API, dropped connection, etc).
                            ? false
