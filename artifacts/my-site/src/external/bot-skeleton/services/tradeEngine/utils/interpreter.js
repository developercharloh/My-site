    ...
    function run(code) {
        return new Promise((resolve, reject) => {
            const onError = e => {
                ...
                // If the user has already clicked Stop (api_base.is_stopping is being
                // set) or the scope was flagged stopped by a concurrent stopBot() call,
                // do NOT restart — honour the user's stop intent.
