...
export const OSCARS_GRIND = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Oscar’s Grind strategy in Mr CharlohFX')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for Oscar’s Grind strategy in Mr CharlohFX.')],
    },
    {
        type: 'text',
        content: [
