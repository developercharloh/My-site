...
export const STRATEGY_1_3_2_6 = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the 1-3-2-6 strategy in Mr CharlohFX')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in Mr CharlohFX with 1-3-2-6 strategy.')],
    },
    {
        type: 'text',
        content: [
