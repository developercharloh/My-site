...
export type TVirtualTransaction = {
    is_won: boolean;
...
type TTransaction = {
    type: string;
    data?: string | TContractInfo | TVirtualTransaction;
};
...
export default class TransactionsStore {
    ...
    constructor(root_store: RootStore, core: TStores) {
        ...
        makeObservable(this, {
            ...
            pushVirtualTransaction: action.bound,
            clear: action.bound,
    ...
    pushVirtualTransaction(data: TVirtualTransaction) {
        const current_account = this.core?.client?.loginid as string;
        ...
        this.elements[current_account]?.unshift({
            type: transaction_elements.VIRTUAL_HOOK,
            data,
        });
    ...
    async recoverPendingContractsById(contract_id: number, contract: ProposalOpenContract | null = null) {
        const positions: TPortfolioPosition[] = this.core.portfolio?.positions ?? [];
