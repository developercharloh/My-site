...
import type { TStores } from '@/types/stores.types';
...
export default class RootStore {
    ...
    public portfolio: PortfolioStore;
    ...
    constructor(dbot: unknown) {
        ...
        this.portfolio = new PortfolioStore(this, this.core);
        this.core.portfolio = this.portfolio;
