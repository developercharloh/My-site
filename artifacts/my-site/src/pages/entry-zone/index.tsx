...
/* ─────────────────────────────────────────────────────────────────
   Color system
   rank 1  → green  (most appearing)
   rank 2  → blue   (2nd most)
   rank 9  → yellow (2nd least)
   rank 10 → red    (least appearing)
...
/* Circle size: scales from 44px (0%) to 72px (max pct ~20%) */
...
───────────────────────────────────────────────────────────────── */
interface TickData {
    distribution: number[];   // [0..9] percentage values
...
/* ─────────────────────────────────────────────────────────────────
   QuadrantRow — renders 5 digit circles with sliding cursor
───────────────────────────────────────────────────────────────── */
...
const EntryZone = () => {
    ...
    const allOptions = MARKETS.flatMap(g => g.items.map(m => ({ value: m.symbol, label: m.label })));
        ...
        <div className='ez-root'>
            ...
            <div className='ez-header'>
                <div className='ez-header__title-block'>
                    <span className='ez-header__title'>Deriv Circles</span>
            ...
            <div className='ez-price-row'>
                ...
                <div className='ez-cursor-tag'>
                    ...
                    {status === 'connecting' && (
                        <Loader2 className='ez-spinner' />
                    )}
                    {status === 'error' && (
                        <WifiOff className='ez-error-icon' />
                    )}
                    {status === 'live' && liveDigit === null && (
                        <Wifi className='ez-wifi-icon' />
                    )}
                </div>
            </div>
