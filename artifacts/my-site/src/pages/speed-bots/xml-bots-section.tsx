...
export const XML_SPEED_BOTS: XmlBotEntry[] = [
    ...
    },
    {
        ...
        emoji:    '⚖️',
        strategy: 'Digit Even/Odd · Entry Scanner · Martingale Toggle',
        desc:     'Scans the last digit each tick to determine entry (EVEN or ODD), buys instantly, then rescans for the next trade. Shows entry point and last digit in journal. Full martingale with enable/disable toggle, target profit, stop loss, and max-loss guard.',
    ...
    },
    {
        ...
        emoji:    '📊',
        strategy: 'Digit Over/Under · Entry Scanner · Barrier Detection · Martingale Toggle',
        desc:     'Scans the last digit each tick: digit ≥ 5 → buys OVER 4, digit ≤ 4 → buys UNDER 5. Rescans before every trade. Shows entry point and last digit in journal. Full martingale with enable/disable toggle, target profit, stop loss, and max-loss guard.',
    ...
    },
    {
        ...
        emoji:    '📈',
        strategy: 'Accumulators · Auto Compounding · Growth Rate',
        desc:     'Automated Accumulators bot. Compounds profits continuously using growth rate ticks. Stops automatically on target profit or stop loss.',
        xmlPath:  '/bots/Accumulators_Pro_Bot_1765711647657.xml',
        gradient: 'linear-gradient(135deg, #0a2200 0%, #1a4400 50%, #2d7a00 100%)',
    },
];
// ▲▲▲  END OF BOT LIST  ▲▲▲
