...
import AiSignalOrb from '@/components/ai-signal-orb/AiSignalOrb';
import './main.scss';
...
const AppWrapper = observer(() => {
    ...
    const handleTabChange = React.useCallback(
        (tab_index: number) => {
            ...
            // On mobile close the run-panel drawer so the tab content is visible
            if (!isDesktop) {
    ...
    return (
        <React.Fragment>
                        ...
                        <Tabs active_index={active_tab} className='main__tabs' onTabItemClick={handleTabChange} top>
                            ...
                            >
                                <div className='analysis-tool-wrapper'>
                                    <Suspense
                                        fallback={
                                            <TabSkeleton variant='chart' label={localize('Please wait, loading D-Circles...')} />
                                        }
                                    >
                                        <SignalEngine />
                                    </Suspense>
            ...
            <DesktopWrapper>
                {active_tab !== DBOT_TABS.SPEED_BOTS && active_tab !== DBOT_TABS.ENTRY_ZONE && active_tab !== DBOT_TABS.V2_PANEL && active_tab !== DBOT_TABS.DTRADER && (
            ...
            <MobileWrapper>
                {!is_open && active_tab !== DBOT_TABS.SPEED_BOTS && active_tab !== DBOT_TABS.ENTRY_ZONE && active_tab !== DBOT_TABS.V2_PANEL && active_tab !== DBOT_TABS.DTRADER && <RunPanel />}
            </MobileWrapper>
            <Dialog
