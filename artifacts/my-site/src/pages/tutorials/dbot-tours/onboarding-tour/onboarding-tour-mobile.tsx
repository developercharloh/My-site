...
const OnboardingTourMobile = observer(() => {
    ...
    React.useEffect(() => {
        // Auto-trigger of the Deriv onboarding tour is disabled on this fork.
        // The tour renders a fixed-position full-screen overlay (.dbot-slider
        // at z-index 1000) that blocks taps on tabs, the Stop button, and the
        // run panel. Users can still launch the tour manually from the
        // Tutorials tab; we just never auto-open it.
